...
export type NodeFormSchema = z.infer<typeof schema>;

export default function NodeForm({ param, totalData = 0 }: { param: NodeFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/cygnus/node?${makeSearchParam(value)}`);
    }
  });
