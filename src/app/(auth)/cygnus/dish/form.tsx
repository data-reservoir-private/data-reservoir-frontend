...
export type DishFormSchema = z.infer<typeof schema>;

export default function DishForm({ param, totalData = 0 }: { param: DishFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/cygnus/dish?${makeSearchParam(value)}`);
    }
  });
