...
export type CropFormSchema = z.infer<typeof schema>;

export default function CropForm({ param, totalData = 0 }: { param: CropFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/cygnus/crop?${makeSearchParam(value)}`);
    }
  });
