...
export type FourPCElementFormSchema = z.infer<typeof schema>;

export default function FourPcElementForm({ param, totalData = 0 }: { param: FourPCElementFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/the-sims/four-pc-element?${makeSearchParam(value)}`);
    }
  });
