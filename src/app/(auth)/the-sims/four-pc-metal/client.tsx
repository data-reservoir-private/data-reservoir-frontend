...
type FourPCMetalFormSchema = z.infer<typeof schema>;
const defaultValue: FourPCMetalFormSchema = { name: "", rarity: undefined };

export default function FourPCMetalClient({ data }: { data: ITheSimsResponse['four-pc-metal'][] }) {
  const [state, setState] = useState<FourPCMetalFormSchema>(defaultValue);
