...
type FourPCCrystalFormSchema = z.infer<typeof schema>;
const defaultValue: FourPCCrystalFormSchema = { name: "", rarity: undefined };

export default function FourPCCrystalClient({ data }: { data: ITheSimsResponse['four-pc-crystal'][] }) {
  const [state, setState] = useState<FourPCCrystalFormSchema>(defaultValue);
  ...
  return (
    <form.AppForm>
      ...
      <SimpleGrid data={realData} link='/the-sims/four-pc-crystal' />
    </form.AppForm>
  )
}
