...
export type FourPCCrystalFormSchema = z.infer<typeof schema>;

export default function FourPCCrystalForm({ param, totalData = 0 }: { param: FourPCCrystalFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/the-sims/four-pc-crystal?${makeSearchParam(value)}`);
    }
  });
