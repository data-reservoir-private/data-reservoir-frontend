...
const grabDetail = cache(async (id: string) => await grabData<ITheSimsResponse['three-pc-gem'] | null>(API_ROUTE.THE_SIMS.THREE_PC_GEM.ID(id)));
    ...
    <Section name={name} variant='h4' className='flex flex-col gap-3' breadcrumbs={[...BREADCRUMBS['the-sims-three-pc-gem-detail'], { label: name }]}>
      ...
      <Paper className='w-full flex justify-center py-5'>
        <Box className='w-50 h-50 relative items-center object-center'>
          <SimpleImage src={data.image} alt={name}/>
        </Box>
      </Paper>
