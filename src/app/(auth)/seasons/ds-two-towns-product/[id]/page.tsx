...
interface DSTwoTownsProductDetailProps {
...
export default async function DSTwoTownsProductDetail(props: DSTwoTownsProductDetailProps) {
  ...
  return (
    <Section name={data.name} variant='h4' className='flex flex-col gap-3' breadcrumbs={[...BREADCRUMBS['seasons-ds-two-towns-product-detail'], { label: data.name }]}>
      {/* Image */}
