...
export type RecipeFormSchema = z.infer<typeof schema>;

export default function RecipeForm({ param, totalData = 0 }: { param: RecipeFormSchema, totalData: number }) {
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value, meta }) => {
      ...
      router.push(`/seasons/ds-mineral-recipe?${makeSearchParam(value)}`);
    }
  });
