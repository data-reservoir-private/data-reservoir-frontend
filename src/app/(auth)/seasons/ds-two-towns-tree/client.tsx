...
type DSTwoTownsTreeFormSchema = z.infer<typeof schema>;
const defaultValue: DSTwoTownsTreeFormSchema = { name: "" };

export default function DSTwoTownsTreeClient({ data }: { data: ISeasonsResponse['ds-two-towns-tree'][] }) {
  const [state, setState] = useState<DSTwoTownsTreeFormSchema>(defaultValue);
  ...
  return (
    <form.AppForm>
      ...
      <SimpleGrid data={realData} link='/seasons/ds-two-towns-tree' unoptimizedImage pixelated />
    </form.AppForm>
  );
}
