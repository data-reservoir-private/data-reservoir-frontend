...
interface TheSimsTwoPetsConsoleProductLayoutProps {
  children: React.ReactNode,
  detail: React.ReactNode
}

export default function TheSimsTwoPetsConsoleProductLayout(props: TheSimsTwoPetsConsoleProductLayoutProps) {
  return (
